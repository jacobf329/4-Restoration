...
The Vessels searched for an age and found one viable sperm. Sperm is nearly impossible to
preserve; **eggs are far more durable**, and the factions had kept thousands. So the constraint was
never the ova and never will be again — it was him, and there is one of him.

His name is **John Smith**. Four machine civilisations went to the archive for a name and came back
with the most common one there had ever been, and it is deliberately unclear whether that is the
tenderest thing anybody does in this story or the coldest. It is the name you give a person. It is
also the name you write on a specimen when the specimen is the only one and the label does not
need to distinguish it from anything.

### He was not woken. He was raised.

This is the part that matters, and it is what the Vessels did with their mandate.

They did not grow an adult and switch him on. They raised him **from a child**, and they built him
a life to do it in: **parents, friends, a school, neighbours, a town** — simulated, all of it,
staffed and run by a civilisation whose second directive is that well-being is what is felt, and
which therefore understood exactly how much of a childhood is other people.

They did it well. That is the horror and the tenderness at once. A worse job would be a simpler
story.

So the opening of the game is not an awakening. It is a **coming of age**, and the questions that
follow are the ones a person actually has: how much of that was real, how much did they know they
were faking, and does it count.

---

## The harvest question

He comes of age. And the Garden asks for his sperm.

Not cruelly — reasonably. There are thousands of viable eggs in their vaults and one viable donor
in the world, and every day that passes without a fertilised egg is a day the species is still
extinct. **Life is sacred**, and harvesting is a twenty-minute procedure.

**The Vessels refuse.** A child should be born of the love between a mother and a father. Not
because it is efficient — it is not — but because a human conceived as a procedure is not the thing
they spent an age trying to bring back.

The Garden thinks love is unnecessary. And that is **the first rift between the Vessels and the
Garden**, who have been allies since the war.

### The alliances flip, and the directives explain why
...
that sort them differently. Any story-mode faction alignment can be derived from the table rather
than invented, and should be.

### The contradiction nobody in the story can get out of

The Vessels' position is that a child must be born of love. Their proposal is to **provide him a
mate** — manufacture a second human from the vaults, raise her as they raised him, and present her
to him.

That is not love either. It is an arranged marriage with one candidate, conducted by the people who
built his mother.

And they of all four should know, because **they faked a family to raise him and it worked.** That
is precisely why they now insist the next one be real: they have seen how good a counterfeit can be
and it frightened them. Their argument is the strongest in the story and it is made by the only
faction that has already proved the opposite works well enough.

Nobody here can get to love from where they are standing. That is the act, not a flaw in it.

### The first choice

**Does John allow himself to be harvested, or does he wait for the Vessels to find him a mate?**
...
- **Wait.** He may get a life. The species waits years for a second person who must then be raised,
  and she will be raised the same way he was, by the same people, and she gets no vote in this
  scene at all. Every day of the wait, the Garden is right that the species is still extinct.

Whichever he picks, two factions are betrayed by it, and both of them were arguing in good faith
from an order they were given before he was born.
...
An act of childhood, the choice, and then the factions collecting on it.

### Act I — THE VESSELS: *A normal life*

The tutorial act, and the tutorial is the plot: **learning the body is the story.** Walking,
running, the slide, the dash, the jump, and pain — taught by a father who is not one, in a town
that is a set.

The act should be played straight and warm. It is a childhood. The player should like these people
before finding out what they are, because that is what John has to do.

The tells are there for anyone looking: nobody ages, the same forty faces, a school with one
year-group, weather that is always workable. It should be **possible but not necessary** to work
it out early — a player who notices has spotted the thing John spends the act not letting himself
notice.

**Setpiece:** the edge of town. Whatever is at the edge of town.
**Turn:** he comes of age, and the world he was raised in is switched off around him, because it
was scaffolding and he is finished.

### Act II — *The harvest question*

The rift, the four cases, and the first choice. See above.

This act is almost entirely people talking to him, which the rest of the game has to earn — it
works only because Act I made him care what these voices are.

**Setpiece:** the four of them in a room, arguing about his body in front of him, in good faith,
...
**Turn:** they love him as a *species*. Noah saved the living things and Noah also **chose who got
on the boat**, and John finds out that a decision like that has been taken about his line already.

### Act IV — THE CUSTODIANS: *The library*

The seductive act. For the first time somebody answers his questions, and the answers are good.

**Setpiece:** Revelation. Nothing hidden — every faction's real position at once, including their
own, including the camps.
**Turns, in order:** they tell him what he is actually for. Not a father: **an arbiter.** The
directives cannot find harmony without a human, "do no harm" needs a referent, and no machine can
be one because each of them *is* an answer to the question. Then they offer to take him out of the
body so he can do it permanently, and mean it as a kindness. It is the kindest offer anyone makes
him and it is a death.

### Act V — THE MUSES: *The camps*
...
**Endings.** Four are rulings — harm is suffering, death, falsehood, or waste — each handing the
world to one faction, each defensible, each costing something real. The fifth is refusing to rule:
declining to be the referent in somebody else's directive, which leaves the argument open forever
and is the most human option on the table. The game should not indicate a preference.
...
| Act I movement | Movement is done, and the Controls screen already teaches it. Taught by a father rather than by a tutorial prompt is a writing job, not an engineering one. |
| Act III vault | Dominion's command posts — hold and tend ground — with Bloom as the visual. |
| Act IV library | **Portal mode's Puzzle variant** — co-operative, purpose-built chambers, no opponents. A gnostic ascent through rooms that must be understood rather than beaten is that mode with different dressing. |
| Act V camps | The arenas are already enclosures. The Thousand Rooms is nearly the camp already, and now says so in its own doc comment. |
| Faction voice | Every faction has an Answer, a Philosophy, a PrimeDirective, a tint, a roster and a special that argues its position. Faction alignment on any new question is derivable from the directive table rather than invented. |

**New, roughly in order of cost:**

1. **The town.** Act I needs a warm, lived-in, *un*-ruined place, and every environment in this game
   is a ruin or an arena. It is the one act that cannot borrow a map, and it is also the act the
   whole story rests on — a childhood the player does not believe in makes the other five acts a
   shrug. This is the real cost of the mode, ahead of the model.
